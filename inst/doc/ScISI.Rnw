...
\Sexpr{length(grep("Y",unique(unlist(lapply(y2hSysGW, function(x)
  names(x))))))} bait proteins and \Sexpr{length(grep("Y",
  (unique(unlist(y2hSysGW)))))} prey proteins by their repsect
