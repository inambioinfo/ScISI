...
Once we have obtained the bait to prey data from IntAct, we need to modify 
...
the systematic gene names to identify the constituent protein members, IntAct 
...
=======
\subfigure[Mapiing from IntAct through an intermediary to systematic genes]{
>>>>>>> .r16780
\label{eg}
