...
hierarchical clusterings. If toGrep is not NULL, parseType must not be NULL neither. The 
terms supplied
...
mips$DESC[setdiff(names(mipsGrep$Mips), names(mips$Mips))]
