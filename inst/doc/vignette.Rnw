...
protein complexes for some cell or tissue under certain conditions. We will focus our
attentions on Saccharomyces cerevisiae though this need not be the case in general.
...
FIXME - this section and all codes need to be completely re-done!!!
